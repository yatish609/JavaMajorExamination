...
public class Validator1 {
    ...
    public static boolean isValidPath (String path)
    {
        if (!Paths.get(path).toFile().isDirectory())
        {
            ...
            PropertyConfigurator.configure("D:/JavaMajorProject/configs/logger/logger.properties");
            try {
                input = new FileInputStream("D:/JavaMajorProject/configs/constants/exceptions.properties");
                prop.load(input);
